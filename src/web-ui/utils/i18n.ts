...
// Local Chinese translations (not yet published to npm)
const defaultChinese: MiniLitRequiredMessages = {
	"*": "*",
	Copy: "复制",
	"Copy code": "复制代码",
	"Copied!": "已复制！",
...
declare module "@mariozechner/mini-lit" {
	interface i18nMessages extends MiniLitRequiredMessages {
		...
		"Custom Model Providers": string;
		"Configure servers with auto-discovered or manually defined models.": string;
		"Add Provider": string;
...
export const translations = {
	en: {
		...
		"Configure servers with auto-discovered or manually defined models.":
			"Configure servers with auto-discovered or manually defined models.",
	...
	de: {
		...
		"Custom Model Providers": "Benutzerdefinierte Modellanbieter",
		"Configure servers with auto-discovered or manually defined models.":
			"Server mit automatisch erkannten oder manuell definierten Modellen konfigurieren.",
	...
	zh: {
		...
		"Error loading PDF": "PDF 加载出错",
		"Error loading document": "文档加载出错",
		"Error loading spreadsheet": "电子表格加载出错",
		...
		"Call was aborted; no result.": "调用已中止；无结果。",
		"No session available": "没有可用会话",
		"No session set": "未设置会话",
		"Preparing tool parameters...": "准备工具参数...",
		"(no output)": "（无输出）",
		Input: "输入",
		Output: "输出",
		"Writing expression...": "编写表达式...",
		"Waiting for expression...": "等待表达式...",
		Calculating: "计算中",
		"Getting current time in": "获取当前时间",
		"Getting current date and time": "获取当前日期和时间",
		"Waiting for command...": "等待命令...",
		"Writing command...": "编写命令...",
		...
		"Proxy URL": "代理 URL",
		"Format: The proxy must accept requests as <proxy-url>/?url=<target-url>":
			"格式：代理必须接受 <代理-url>/?url=<目标-url> 格式的请求",
		"Settings are stored locally in your browser": "设置存储在浏览器本地",
		Clear: "清除",
		"API Key Required": "需要 API 密钥",
		"Enter your API key for {provider}": "请输入 {provider} 的 API 密钥",
		"Allows browser-based apps to bypass CORS restrictions when calling LLM providers. Required for Z-AI and Anthropic with OAuth token.":
			"允许浏览器应用绕过 CORS 限制来调用 LLM 提供商。Z-AI 和使用 OAuth 令牌的 Anthropic 需要此项。",
		Off: "关闭",
		Minimal: "最少",
		Low: "低",
		Medium: "中",
		...
		"This app needs persistent storage to save your conversations": "此应用需要持久化存储来保存对话",
		"Why is this needed?": "为什么需要这个？",
		"Without persistent storage, your browser may delete saved conversations when it needs disk space. Granting this permission ensures your chat history is preserved.":
			"没有持久化存储，浏览器在需要磁盘空间时可能会删除已保存的对话。授予此权限可确保聊天记录被保留。",
		"What this means:": "这意味着：",
		"Your conversations will be saved locally in your browser": "对话将保存在浏览器本地",
		"Data will not be deleted automatically to free up space": "数据不会因释放空间而被自动删除",
		...
		"Providers & Models": "提供商和模型",
		"Cloud Providers": "云端提供商",
		"Cloud LLM providers with predefined models. API keys are stored locally in your browser.":
			"云端 LLM 提供商，提供预定义模型。API 密钥存储在浏览器本地。",
		"Custom Providers": "自定义提供商",
		"User-configured servers with auto-discovered or manually defined models.":
			"用户配置的服务器，支持自动发现或手动定义模型。",
		"Custom Model Providers": "自定义模型提供商",
		"Configure servers with auto-discovered or manually defined models.": "配置自动发现或手动定义的模型服务器。",
		"Add Provider": "添加提供商",
		"No custom providers configured. Click 'Add Provider' to get started.":
			"尚未配置自定义提供商。点击「添加提供商」开始。",
		"auto-discovered": "自动发现",
		Refresh: "刷新",
		Edit: "编辑",
		"Are you sure you want to delete this provider?": "确定要删除此提供商吗？",
		"Edit Provider": "编辑提供商",
		"Provider Name": "提供商名称",
		...
		"Leave empty if not required": "不需要时留空",
